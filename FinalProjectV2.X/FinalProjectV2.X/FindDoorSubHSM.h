...
#ifndef FIND_DOOR_SUB_HSM_H  // <- This should be changed to your own guard on both
#define FIND_DOOR_SUB_HSM_H  //    of these lines
...
/**
 * @Function InitFindDoorSubHSM(void)
